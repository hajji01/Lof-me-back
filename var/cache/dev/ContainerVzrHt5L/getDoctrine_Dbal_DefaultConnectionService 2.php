...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['dbname' => 'hajji_za', 'user' => 'hajji', 'password' => 'Zysos2901', 'host' => 'mysql-hajji.alwaysdata.net', 'driver' => 'pdo_mysql', 'port' => NULL, 'driverOptions' => [], 'serverVersion' => '8', 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
